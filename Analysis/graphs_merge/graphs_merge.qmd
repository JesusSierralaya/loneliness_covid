...
```{r}
plot_disability_pre <- db_pivot_2 |> # [Change here]
...
```{r}
plot_disability_post <- db_pivot_2 |> # [Change here]
...
```{r}
plot_neuroticism <- db_pivot_2 |> # [Change here]
  # drop_na(whodas12_post) |> 
...
```{r}
plot_extraversion <- db_pivot_2 |> # [Change here]
  # drop_na(whodas12_post) |> 
...
```{r}
plot_resilience <- db_pivot_2 |> # [Change here]
  # drop_na(whodas12_post) |> 
...
# to png
png(file = "../../results_28_jul_22/plot_sociod.png",
    width = 10, height = 10,
    res = 900, units = "in")
plot_sociod
dev.off()
...
# to png
png(file = "../../results_28_jul_22/plot_social.png",
    width = 10, height = 10,
    res = 900, units = "in")
plot_social
dev.off()
...
# to png
png(file = "../../results_28_jul_22/plot_health.png",
